 ...
 * de qual categoria são. O preço do site só aparece se o dono ligar.
 */
export function CatalogoLojista({ linhas, descontoPercent, condicoes, mostrarPrecoSite, whatsapp, cnpj, endereco, data }: {
  ...
  const introducao = `${linhas.length} ${linhas.length === 1 ? "item" : "itens"} em estoque, com ${formatarDesconto(descontoPercent)} de desconto sobre o preço à vista do site.`
