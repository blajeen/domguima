...
export function ProductForm({ product, categories, operationalMeta, initialCategoryId = "", skuChoices = [], templates = [] }: ProductFormProps) {
  ...
  return <form action={action} className="space-y-6">
    ...
    <Section title="Preço, estoque e publicação" description="Veja a margem antes de pesquisar o preço de mercado."><div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
