  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-20 text-center">
      ...
      <p className="mx-auto mt-3 max-w-md text-sm leading-relaxed text-ink-600">
        Abrimos uma conversa no WhatsApp com o resumo do seu pedido. Se a janela
        não abriu, é só clicar no botão abaixo — o resumo continua lá.
      </p>
      <p className="mt-4 text-sm text-ink-500">
        Vamos confirmar o frete, o prazo e a forma de pagamento com você antes de
        qualquer cobrança.
      </p>
      ...
      <div className="mt-8 flex flex-wrap justify-center gap-3">
        ...
        >
          Abrir WhatsApp {whatsapp.display}
        </a>
        <Link
          href="/"
